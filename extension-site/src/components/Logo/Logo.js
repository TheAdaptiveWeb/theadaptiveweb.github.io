            ...
            <LogoSvg animate={this.props.animate}>
                <defs>
                    <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradient-1">
                        <stop stopColor="#77BCEE" offset="0%"></stop>
                        <stop stopColor="#4A90E2" offset="100%"></stop>
                    </linearGradient>
                </defs>
                    ...
                    <g id="Logo" fillRule="nonzero">
                        <g id="Group-2">
                            <g transform="translate(-97.000000, 0.000000)">
                                ...
                                <g id="Group" transform="translate(0.000000, 303.000000)" stroke="#FFFFFF" strokeWidth="50">
                                ...
                                <circle id="Oval-2" stroke="#FFFFFF" strokeWidth="50" fill="#95C6FF" cx="582" cy="485" r="75"></circle>
                            </g>
                        </g>
                    </g>
                </g>
